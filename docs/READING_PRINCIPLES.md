...
## How these principles inform the redesign

- Schwabish supports selecting chart type based on analytical task and readability, rather than preserving the original form.
- Tufte supports reducing decorative clutter and organizing visual hierarchy around the data.
- Dunford supports minimizing unnecessary variables, clarifying color use, and avoiding visually tangled displays.
- Together, these principles justify prioritizing clarity over novelty while still documenting alternative designs as part of an iterative process.
